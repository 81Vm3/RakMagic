...
char *CAnimationInfo::GetNameByIndex(short wIndex) {
...
short CAnimationInfo::GetIndexByName(char *szName)
{
	for (int i = 0; szName[i]; i++) {
		szName[i] = static_cast<char>(toupper(szName[i]));
	}
	for (short i = 0; i < MAX_ANIMATIONS; i++) {
